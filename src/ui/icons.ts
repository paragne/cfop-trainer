...
// A cube in outline, for the choice of how the 3D cube looks.
export const AESTHETIC_ICON =
  '<svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" aria-hidden="true"><path d="M12 3L20 7.5V16.5L12 21L4 16.5V7.5L12 3Z"/><path d="M4 7.5L12 12L20 7.5"/><path d="M12 12V21"/></svg>';

// The app's mark, next to the credit line at the foot of the home screen.
...
// A bulleted list: the case's algorithms, to pick one from.
export const ALG_LIST_ICON = icon(
  24,
